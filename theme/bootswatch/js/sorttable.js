...
function doPull()	{
	...
	myFrm = document.forms["myFrm"];
	myAside = document.forms["myAside"];
	

	arGroup = myAside.group_joint[document.myAside.group_joint.selectedIndex].value.split(":");
	...
	myFrm.other_permission.value 	= document.forms["myAside"].other_permission[myAside.other_permission.selectedIndex].value;
	myFrm.public_permission.value 	= myAside.public_permission[myAside.public_permission.selectedIndex].value;
	myFrm.pinned.value 				= myAside.pinned.checked; 
	...
	for (var i = 0; i < myAside.facet.length; i++)	{
		
		myFrm.facet[i].value		= myAside.facet[i][myAside.facet[i].selectedIndex].value;
		}
