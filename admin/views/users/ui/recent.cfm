...
<tr>
	<td>
		<a href="##" rel="popover" data-content="Kind: #Kind# Modified: #application.IOAPI.std_date(ModifyDate)# By: #ModifyBy#
	Created: #application.IOAPI.std_date(CreateDate)# By: #CreateBy#">
			<i class="#Icon#"></i>
		</a>
	</td>
	<td></td>
